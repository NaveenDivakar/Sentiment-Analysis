...
model = AutoModelForSequenceClassification.from_pretrained('sentiment_model1', num_labels=3)
tokenizer = AutoTokenizer.from_pretrained('sentiment_model2')

# Load the dataset with product scores
df = pd.read_csv('flipkart_reviews_with_score_based_recommendations.csv')
